...
const cloudVisionKey = 'AIzaSyBM1YssJJ_DZLCCDm4sU5mFXQYWfVaiNUM';
const cloudVision  = 'https://vision.googleapis.com/v1/images:annotate?key=' + cloudVisionKey;


export default class ScanId extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      captureText: null,
  ...
  showAlert(title, message) {
    ...
    setTimeout(()=>{
      Alert.alert(
        ...
        message,
        [
          {text: 'Use this data', onPress: () => console.log('OK Pressed')},
          {text: 'Retake Photo', onPress: () => console.log('OK Pressed')}
        ]
      )
    }, 100);
  }
        ...
        <View style={styles.container}>
          ...
          <Camera 
            ref={ref => {
             ...
             <Image source={require('../../../assets/images/idmask.png')} style={styles.mask}/>
            <View style={styles.bottom}>
              <TouchableOpacity onPress={this._takeImage.bind(this)}>
                <Image source={require('../../../assets/images/take.png')}  style={styles.take}/>
              </TouchableOpacity>
            </View>
          </Camera>
        </View>
