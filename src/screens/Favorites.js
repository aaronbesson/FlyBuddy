...
export default class Arrivals extends React.Component {
  ...
  componentDidMount() {
    return fetch('http://aviation-edge.com/v2/public/timetable?key=d987cd-3b4caf&iataCode=POS&type=arrival')
    ...
    if (this.state.isSignedIn) {
      ...
      return <View style={styles.MainContainer}>
        ...
        <ScrollView horizontal={true}
          ...
          style={{ flexDirection: 'row', marginBottom: 20, height: 50, backgroundColor: 'black' }}>

          <View style={styles.news}>
            <Text style={styles.h1}>Flights</Text>
          </View>

          <View style={styles.news1}>
            <Text style={styles.h1}>Gates</Text>
          </View>

          <View style={styles.news1}>
            <Text style={styles.h1}>Customs</Text>

          </View>

          <View style={styles.news1}>
            <Text style={styles.h1}>Bathrooms</Text>
        ...
        <Text style={styles.instructions}>
          My saved flight details: {this.state.myKey}
        </Text>
              ...
              <View style={styles.flightCard} >
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', width: '50%', padding: 10 }}>
                  ...
                  <TouchableOpacity style={styles.numberBk} onPress={this.getKey.bind(this)}>
                    <Text style={{ textAlign: 'center', fontSize: 24, color: 'white', fontWeight: 'bold' }}>{rowData.flight.iataNumber}</Text>
                  </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  h1: { fontSize: 21, color: 'white', fontWeight: 'bold' },
  TextInputStyleClass: {
    backgroundColor: '#fff',
    flexDirection: 'row',
    paddingVertical: 10,
